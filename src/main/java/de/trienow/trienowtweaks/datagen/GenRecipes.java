...
public class GenRecipes extends RecipeProvider
{
	...
	protected void buildRecipes(Consumer<FinishedRecipe> pWriter)
	{
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, AtomItemBlocks.TORCH_SOLAMNIA.get(), 8)
				...
				.pattern("C")
				.pattern("L")
				.save(pWriter, recipeVariant(AtomItemBlocks.TORCH_SOLAMNIA, "coal"));
